...
def trylogin(payload, attempts):
    ...
    for i in range(0,attempts):
        ...
        start = time.clock()
        response = session.post('https://christopherburgess.xyz/WebSecurity/login.php',headers=headers,data=payload)
...
payload_good = {'username':'Admin', 'password':'1234567890'}
payload_badpassword = {'username':'Admin', 'password':'password10x'}
